...
page = requests.get("https://shannendowling.github.io/FYPSample/sitemap.html")
page
...
#HTML classes/ids 
#Data for training
#nav = soup.find_all(class_="nav")
#image = soup.find_all(class_="image")
sitemap = soup.find_all(id="sitemap")
...
with open('indexBnB5.csv', 'a') as csv_file:
	writer = csv.writer(csv_file)
	writer.writerow([sitemap, datetime.now()])
